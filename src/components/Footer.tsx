      ...
      <div className="section-padding py-10 lg:py-14">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3 text-brand-text-muted text-[14px]">
                ...
                <span>123 Baker Street, Food District, City - 400001</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/[0.06] mt-8 pt-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-5 text-brand-text-dim text-[12px] font-semibold">
            <span className="hover:text-brand-text-muted cursor-pointer transition-colors">Privacy Policy</span>
            <span className="hover:text-brand-text-muted cursor-pointer transition-colors">Terms of Service</span>
          </div>
        </div>
      </div>
    </footer>
