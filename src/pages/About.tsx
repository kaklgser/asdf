      ...
      <section className="section-padding py-16 lg:py-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 lg:gap-8">
          {[
            ...
            <div
              key={item.title}
              className="bg-brand-surface rounded-xl p-6 border border-white/[0.06] hover:border-brand-gold/20 transition-all duration-300 text-center"
            >
      ...
      <section className="py-16 lg:py-24">
        <div className="section-padding">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            <div className="bg-brand-surface rounded-xl p-6 border border-white/[0.06]">
              ...
              <div className="space-y-5 mb-8">
                {[
                  ...
                  { icon: MapPin, label: 'Address', value: '123 Baker Street, Food District, City - 400001' },
                ].map((item) => (
