  ...
  return (
    <div className="min-h-screen bg-brand-bg">
      <div className="max-w-lg mx-auto px-4 py-6 pb-24 animate-fade-in">
        ...
        <div className="bg-brand-surface rounded-2xl border border-white/[0.06] p-5 mb-4">
            ...
            {!editing ? (
              ...
              <div className="flex flex-col gap-1.5 flex-shrink-0">
                ...
                <button
                  ...
                  className="p-2 rounded-lg text-brand-text-dim hover:bg-white/5 transition-colors"
                >
                  <X size={16} />
                </button>
              </div>
        ...
        <div className="space-y-2 mb-6">
          <Link
            to="/my-orders"
            className="flex items-center justify-between bg-brand-surface rounded-xl px-4 py-3.5 border border-white/[0.06] transition-all active:scale-[0.98] hover:border-white/10"
          >
