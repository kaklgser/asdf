...
export default function AdminDashboard() {
  ...
  const confirmedOrders = orders.filter((o) => o.status !== 'pending' && o.status !== 'cancelled' && o.status !== 'expired').length;
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {stats.map((stat) => (
          <div key={stat.label} className="bg-brand-surface rounded-xl p-4 border border-white/[0.06]">
