...
import { LayoutDashboard, ShoppingBag, UtensilsCrossed, MapPin, Tag, LogOut, MessageCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-brand-bg flex">
      <aside className="hidden lg:flex flex-col w-56 bg-brand-bg text-white fixed inset-y-0 left-0">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors ${
                  isActive ? 'bg-brand-gold/10 text-brand-gold' : 'text-brand-text-dim hover:text-brand-gold hover:bg-white/5'
                }`
              }
            >
              <item.icon size={18} />
        ...
        <div className="p-3 border-t border-white/[0.06]">
          <button
            ...
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-brand-text-dim hover:text-brand-gold hover:bg-white/5 w-full transition-colors"
          >
            <LogOut size={18} />
            Sign Out
          </button>
      ...
      <div className="lg:ml-56 flex-1 flex flex-col">
        <header className="lg:hidden bg-brand-surface border-b border-white/[0.06] px-4 py-3">
