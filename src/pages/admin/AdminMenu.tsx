  ...
  return (
    <div>
      ...
      <div className="mb-8">
        ...
        {showCatForm && (
          <div className="bg-brand-surface rounded-xl border border-white/[0.06] p-4 mb-4 space-y-3">
        ...
        <div className="flex flex-wrap gap-2">
          {categories.map((cat) => (
            <div key={cat.id} className="flex items-center gap-2 bg-brand-surface border border-white/[0.06] rounded-lg px-3 py-2 text-sm">
      ...
      <div>
        ...
        <div className="space-y-2">
          {items.map((item) => (
            <div key={item.id} className="bg-brand-surface rounded-xl border border-white/[0.06] p-3 flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  {!item.is_available && <span className="text-[10px] bg-white/[0.06] text-brand-text-dim px-1.5 py-0.5 rounded">Unavailable</span>}
                </div>
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="p-2 hover:bg-white/[0.06] rounded-lg text-brand-text-dim hover:text-white transition-colors"
                >
                  <Pencil size={14} />
                </button>
